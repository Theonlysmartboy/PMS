...
function make_safe($variable) {
    ...
    $variable1 = strip_tags(mysqli_real_escape_string($link, trim($variable)));
    return $variable1;
}
?>
<!DOCTYPE html>
    ...
    <head>
        ...
        <meta name="description" content="Real estate management, Property management,  ">
            ...
            <link rel="icon" type="image/png" href="<?php echo WEB_URL; ?>assets/img/vidiclogo.png">
                <!-- BOOTSTRAP STYLES-->
                <link href="<?php echo WEB_URL; ?>assets/css/bootstrap.css" rel="stylesheet" />
                <!-- FONTAWESOME STYLES-->
                <link href="<?php echo WEB_URL; ?>assets/css/font-awesome.css" rel="stylesheet" />
                <!-- CUSTOM STYLES-->
                <link href="<?php echo WEB_URL; ?>assets/css/custom.css" rel="stylesheet" />
                <!-- GOOGLE FONTS-->
