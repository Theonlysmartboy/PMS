            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <table class="table sakotable table-bordered table-striped dt-responsive">
                        ...
                        <tbody>
                            <?php
                            $result = mysqli_query($link, "Select *,ar.image as r_image,ar.r_name,fl.floor_no as fl_floor,u.unit_no as u_unit,m.month_name, y.xyear from tbl_add_fair f inner join tbl_add_floor fl on fl.fid = f.floor_no inner join tbl_add_unit u on u.uid = f.unit_no inner join tbl_add_month_setup m on m.m_id = f.month_id inner join tbl_add_year_setup y on y.y_id = f.y_id inner join tbl_add_rent ar on ar.rid = f.rid where f.type = 'Rented' and f.branch_id = " . (int) $_SESSION['objLogin']['branch_id'] . " order by f.f_id desc");
