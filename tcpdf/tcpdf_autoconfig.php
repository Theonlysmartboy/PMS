...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'assets/img/vidiclogo.png/', K_PATH_MAIN.'assets/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN);
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'vidiclogo.png')) {
		$tcpdf_header_logo = 'vidiclogo.png';
	}
...
if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Victoria Interdiocesan Investment company");
}
